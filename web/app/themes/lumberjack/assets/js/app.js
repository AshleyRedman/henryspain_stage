...
__webpack_require__(/*! ./guideSlider */ "./resources/js/guideSlider.js");

var scroll = new smooth_scroll__WEBPACK_IMPORTED_MODULE_1___default.a('a[href*="#');

if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('video')) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("video").prop("volume", 0.1);
}

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').click(function (e) {
  e.preventDefault();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.mobile-menu a').click(function (e) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').removeClass('open');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.mobile-menu').removeClass('active');
});

/***/ }),

/***/ "./resources/js/guideSlider.js":
/*!*************************************!*\
  !*** ./resources/js/guideSlider.js ***!
  \*************************************/
/*! no exports provided */
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guide-slider__wrap').slick({
  lazyLoad: 'ondemand',
  infinite: true,
  slidesToShow: 3,
  slidesToScroll: 1,
...
__webpack_require__(/*! C:\laragon\www\hs\web\app\themes\lumberjack\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\hs\web\app\themes\lumberjack\resources\sass\app.scss */"./resources/sass/app.scss");
